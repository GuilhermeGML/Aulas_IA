...
* Aula Perceptron - ([Código](https://github.com/claytontey/Aulas_IA/tree/main/perceptron/src))

* Aula Regressão Linear Simples - ([Código](https://github.com/claytontey/Aulas_IA/blob/main/linear_regression/aula_regressao.py))
